package com.disappears.android.agora.openvcall.model;
...
public class ConstantApp {
    ...
    public static final int MIN_AMOUNT_OF_MEMBERS_IN_CONVERSATION = 2;
    ...
    public static final String ACTION_KEY_CHANNEL_MEMBERS = "ACTION_KEY_CHANNEL_MEMBERS";
    public static final String ACTION_KEY_IS_VIDEO_ENABLED = "ACTION_KEY_IS_VIDEO_ENABLED";
