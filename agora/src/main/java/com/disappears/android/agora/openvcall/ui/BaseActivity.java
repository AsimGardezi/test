...
import com.disappears.android.agora.openvcall.model.CurrentUserSettings;
...
import static com.disappears.android.agora.openvcall.model.ConstantApp.PERMISSION_REQ_ID_WRITE_EXTERNAL_STORAGE;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.CAMERA.equals(permission)) {
            ((WorkerThreadHolder) getApplication()).initWorkerThread();
        }
        return true;
    }

    protected RtcEngine rtcEngine() {
        return ((WorkerThreadHolder) getApplication()).getWorkerThread().getRtcEngine();
    }

    @Nullable
    protected final WorkerThread worker() {
        return ((WorkerThreadHolder) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((WorkerThreadHolder) getApplication()).getWorkerThread().getEngineConfig();
    }

    @Nullable
    protected final MyEngineEventHandler event() {
        return ((WorkerThreadHolder) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return ((UserSettingsHolder)getApplication()).VIDEO_SETTINGS;
    }
